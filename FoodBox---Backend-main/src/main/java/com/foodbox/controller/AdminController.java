...
public class AdminController {
	...
	public boolean verifyAdminLogin(@RequestBody Map loginData, @PathVariable(name = "username") String username,
			HttpSession session) {
	...
	public Boolean adminlogin(@RequestBody String email, String password) {
